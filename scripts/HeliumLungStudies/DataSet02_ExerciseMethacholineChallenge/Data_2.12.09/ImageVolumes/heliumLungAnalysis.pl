...
$output = $outputDirectory . "/apocrita_ventilation_ratio_both_1_" . $PID . ".txt";
$out = `$command 3 $apocritaImage 1 $initialSegmentation 1 > $output`;
 ...
 $output = $outputDirectory . "/apocrita_ventilation_ratio_both_statistics_1_" . $PID . ".txt";
 $out = `$command 3 $heliumImage $apocritaImage 1 > $output`;

$command = $utilityDirectory . "CalculateVolumeFromBinaryImage";
$output = $outputDirectory . "/apocrita_ventilation_ratio_both_2_" . $PID . ".txt";
$out = `$command 3 $apocritaImage 2 $initialSegmentation 1 > $output`;
 $command = $utilityDirectory . "CalculateFirstOrderStatisticsFromImage";
 $output = $outputDirectory . "/apocrita_ventilation_ratio_both_statistics_2_" . $PID . ".txt";
 $out = `$command 3 $heliumImage $apocritaImage 2 > $output`;

#  $command = $utilityDirectory . "CalculateVolumeFromBinaryImage";
#  $output = $outputDirectory . "/apocrita_ventilation_ratio_both_3_" . $PID . ".txt";
#  $out = `$command 3 $apocritaImage 3 $initialSegmentation 1 > $output`;
#  $command = $utilityDirectory . "CalculateFirstOrderStatisticsFromImage";
#  $output = $outputDirectory . "/apocrita_ventilation_ratio_both_statistics_3_" . $PID . ".txt";
#  $out = `$command 3 $heliumImage $apocritaImage 3 > $output`;
