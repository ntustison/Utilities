...
$templateDirectory = "/home/tustison/Data/HeliumLungStudies/He3Template/Coronal/";
$template = $templateDirectory . "CORONAL2_template_biascorrected.nii.gz";
$templateSegmentation = $templateDirectory . "CORONAL2_template_segmentation.nii.gz";
...
@args = ( $utilityDirectory . "InhomogeneityCorrectImage", 3, 
  $uncorrectedHeliumImage, $heliumImage, 1, "nofile", 50, 4, 
...
@args = ( $utilityDirectory . "ChangeImageInformation", 3, 
  $heliumImage, $heliumImage, 0, "0x0x0" );
system( @args ) == 0 or die "system @args failed: $?";
@args = ( $utilityDirectory . "ChangeImageInformation", 3, 
  $heliumImage, $heliumImage, 2 );
system( @args ) == 0 or die "system @args failed: $?";
