...
if [[ ! -f $BRAIN_SEGMENTATION ]];
  then
    ...
    TMP_FILES=( $SEGMENTATION_WARP $SEGMENTATION_INVERSE_WARP $SEGMENTATION_AFFINE $SEGMENTATION_RIGID $SEGMENTATION_TRANSLATION $SEGMENTATION_WHITE_MATTER_MASK $SEGMENTATION_BRAIN ${SEGMENTATION_BRAIN_N4_IMAGES[@]} )
