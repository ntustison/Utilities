/*=========================================================================
  ...
  Module:    $RCSfile: itkJensenTsallisBSplineRegistrationFunction.h,v $
  Language:  C++
...
public:
  ...
  void SetAlpha( RealType r )  { this->m_Alpha = r; }
  RealType GetAlpha()  { return this->m_Alpha; }

  void SetUseRegularizationTerm( bool b )  { this->m_UseRegularizationTerm = b; }
  RealType GetUseRegularizationTerm()  { return this->m_UseRegularizationTerm; }

  void SetUseInputAsSamples( bool b )  { this->m_UseInputAsSamples = b; }
  RealType GetUseInputAsSamples()  { return this->m_UseInputAsSamples; }

  void SetUseAnisotropicCovariances( bool b )  { this->m_UseAnisotropicCovariances = b; }
  RealType GetUseAnisotropicCovariances()  { return this->m_UseAnisotropicCovariances; }

  void SetFixedPointSetSigma( RealType r )  { this->m_FixedPointSetSigma = r; }
  RealType GetFixedPointSetSigma()  { return this->m_FixedPointSetSigma; }
  ...
  unsigned long GetNumberOfFixedSamples()  { return this->m_NumberOfFixedSamples; }

  void SetMovingPointSetSigma( RealType r )  { this->m_MovingPointSetSigma = r; }
  RealType GetMovingPointSetSigma()  { return this->m_MovingPointSetSigma; }
  ...
  unsigned long GetNumberOfMovingSamples()  { return this->m_NumberOfMovingSamples; }

  void SetMeshResolution( ArrayType a )  { this->m_MeshResolution = a; }
  ArrayType GetMeshResolution()  { return this->m_MeshResolution; }

  void SetNumberOfLevels( unsigned int r )  { this->m_NumberOfLevels = r; }
  unsigned int GetNumberOfLevels()  { return this->m_NumberOfLevels; }

  void SetSplineOrder( unsigned int r )  { this->m_SplineOrder = r; }
  unsigned int GetSplineOrder()  { return this->m_SplineOrder; }
  ...
  virtual VectorType ComputeUpdate(
    const NeighborhoodType &neighborhood,
    void *globalData,
    const FloatOffsetType &offset = FloatOffsetType( 0.0 ) );

  virtual VectorType ComputeUpdateInv(
    const NeighborhoodType &neighborhood,
    void *globalData,
    const FloatOffsetType &offset = FloatOffsetType( 0.0 ) );
