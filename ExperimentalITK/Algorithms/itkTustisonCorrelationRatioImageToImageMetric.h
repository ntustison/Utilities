/*=========================================================================
  ...
  Module:    $RCSfile: itkTustisonCorrelationRatioImageToImageMetric.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkTustisonCorrelationRatioImageToImageMetric_h
#define __itkTustisonCorrelationRatioImageToImageMetric_h
...
/** \class TustisonCorrelationRatioImageToImageMetric
 * \brief Computes the mutual information between two images to be 
 * registered using the method of Mattes et al.
 *
 * TustisonCorrelationRatioImageToImageMetric computes the correlation
 * ratio between a fixed and moving image to be registered.
 *
...
class ITK_EXPORT TustisonCorrelationRatioImageToImageMetric :
    public ImageToImageMetric< TFixedImage, TMovingImage >
{
public:

  /** Standard class typedefs. */
  typedef TustisonCorrelationRatioImageToImageMetric  Self;
  ...
  itkTypeMacro(TustisonCorrelationRatioImageToImageMetric, ImageToImageMetric);
...
protected:
  ...
  virtual ~TustisonCorrelationRatioImageToImageMetric() {};
...
private:
  ...
  TustisonCorrelationRatioImageToImageMetric(const Self&); //purposely not implemented
