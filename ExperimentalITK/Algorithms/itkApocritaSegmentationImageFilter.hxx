/*=========================================================================
  ...
  Module:    $RCSfile: itkApocritaSegmentationImageFilter.hxx,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
=========================================================================*/
#ifndef __itkApocritaSegmentationImageFilter_hxx
#define __itkApocritaSegmentationImageFilter_hxx
...
::UpdateClassParametersAndLabeling()
{
  ...
  for( unsigned int n = 0; n < this->m_NumberOfClasses; n++ )
    ...
    if( denominator > 0.0 )
      ...
      {
      this->m_CurrentClassParameters[n][2] = 0.0;
      }
    }
