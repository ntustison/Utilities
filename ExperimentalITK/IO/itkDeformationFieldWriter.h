/*=========================================================================
  ...
  Module:    $RCSfile: itkDeformationFieldWriter.h,v $
  Language:  C++
  Date:      $$
  Version:   $ $
...
=========================================================================*/
#ifndef __itkDeformationFieldWriter_h
#define __itkDeformationFieldWriter_h
...
class DeformationFieldWriterException : public ExceptionObject 
{
public:
  /** Run-time information. */
  itkTypeMacro( DeformationFieldWriterException, ExceptionObject );

  /** Constructor. */
  DeformationFieldWriterException(const char *file, unsigned int line, 
  ...
  /** Constructor. */
  DeformationFieldWriterException(const std::string &file, unsigned int line, 
                           const char* message = "Error in IO",
                           const char* loc = "Unknown" ) :
    ExceptionObject(file, line, message, loc)
  {
...
class ITK_EXPORT DeformationFieldWriter : 
  public ProcessObject
{
public:
  /** Standard class typedefs. */
  typedef DeformationFieldWriter                  Self;
  ...
  itkTypeMacro(DeformationFieldWriter, DeformationFieldWriter);
  ...
  void SetInput(const DeformationFieldType *input);
  const DeformationFieldType * GetInput(void);
  const DeformationFieldType * GetInput(unsigned int idx);
...
private:
  DeformationFieldWriter(const Self&); //purposely not implemented
