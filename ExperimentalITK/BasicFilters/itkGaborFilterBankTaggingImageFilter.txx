#ifndef __itkGaborFilterBankTaggingImageFilter_txx
#define __itkGaborFilterBankTaggingImageFilter_txx
...
GaborFilterBankTaggingImageFilter<TInputImage, TOutputImage>
  ...
  */  
  ...
  for ( RealType tagSpacing = this->m_TagSpacingMinimum; 
    ...
    for ( RealType phi = this->m_RotationAngleMinimum[2]; 
          ...
          phi += ( this->m_RotationAngleMaximum[2] - this->m_RotationAngleMinimum[2] ) 
      ...
      for ( RealType psi = this->m_RotationAngleMinimum[1]; 
        ...
        for ( RealType theta = this->m_RotationAngleMinimum[0]; 
          ...
          {
//          std::cout << "Iteration " << iteration << ": " << tagSpacing << ", " << phi << ", " << psi << ", " << theta << std::endl; 
  ...
  */
          ArrayType sigma;
//          sigma[0] = 0.25 / tagSpacing;
//          sigma[1] = sigma[2] = 4.0 * sigma[0]; 
          sigma[0] = 0.4 / tagSpacing;
          sigma[1] = sigma[2] = 7.5 * sigma[0]; 
