 ...
 *
 *=========================================================================*/
#ifndef __itkScalarImageToRunLengthFeaturesFilter_txx
#define __itkScalarImageToRunLengthFeaturesFilter_txx
...
::ScalarImageToRunLengthFeaturesFilter()
{
  ...
  typedef Neighborhood<ITK_TYPENAME ImageType::PixelType,
