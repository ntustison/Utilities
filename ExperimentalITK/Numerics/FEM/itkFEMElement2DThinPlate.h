/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement2DThinPlate.h,v $
  Language:  C++
  Date:      $ $
  Version:   $ $
...
#ifndef __itkFEMElement2DThinPlate_h
#define __itkFEMElement2DThinPlate_h
...
/**
 * \class Element2DThinPlate
 * \brief Class that is used to define a thin-plate energy problem in 2D space.
 *
 ...
 *
 *   TBaseClass - Class from which Element2DThinPlate is derived. TBaseClass must
...
class Element2DThinPlate : public TBaseClass
{
FEM_ABSTRACT_CLASS(Element2DThinPlate,TBaseClass)
public:
...
//////////////////////////////////////////////////////////////////////////
   ...
   */
  virtual void GetStrainDisplacementMatrix(MatrixType& B, const MatrixType& shape2Dgl) const;
