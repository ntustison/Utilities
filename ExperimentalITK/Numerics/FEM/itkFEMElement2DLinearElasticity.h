/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement2DLinearElasticity.h,v $
  Language:  C++
...
#ifndef __itkFEMElement2DLinearElasticity_h
#define __itkFEMElement2DLinearElasticity_h
...
/**
 * \class Element2DLinearElasticity
 ...
 *
 *   TBaseClass - Class from which Element2DLinearElasticity is derived. TBaseClass must
...
class Element2DLinearElasticity : public TBaseClass
{
FEM_ABSTRACT_CLASS(Element2DLinearElasticity,TBaseClass)
public:
...
//////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Compute the mass matrix specific for 2D LinearElasticity problems.
   */
  void GetMassMatrix(MatrixType& Me) const;


  /**
   * 2D LinearElasticity elements have 2 DOFs per node.
   */
...
#include "itkFEMElement2DLinearElasticity.txx"
#endif

#endif  // #ifndef __itkFEMElement2DLinearElasticity_h
