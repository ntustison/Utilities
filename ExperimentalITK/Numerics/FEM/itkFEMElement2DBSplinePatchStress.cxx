/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement2DBSplinePatchStress.cxx,v $
  Language:  C++
...
::Element2DBSplinePatchStress() : Superclass()
{
}
      ...
      Material::ConstPointer m_) : Superclass()
{
  ...
  {
    throw FEMExceptionWrongClass(__FILE__,__LINE__,"Element2DBSplinePatchStress::Element2DBSplinePatchStress()");
  }
}
...
FEM_CLASS_REGISTER(Element2DBSplinePatchStress)
