...
public:
  ...
  /**
    * Get the maximum number of non zero elements used to initialize the sparse
    *  matrix solver
    */
  unsigned long GetMaximumNumberOfNonZeroElements( void );
  
  /**
    * Set the maximum number of non zero elements used to initialize the sparse
    *  matrix solver
    */
  void SetMaximumNumberOfNonZeroElements( unsigned long nze ) { m_NZE = nze; };
