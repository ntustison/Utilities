...
public:
  ...
  /*
   * Other essential typedefs
   */
  typedef vnl_vector<int> IntVectorType;
  typedef vnl_matrix<int> IntMatrixType;
  typedef vnl_vector<unsigned int> UIntVectorType;
  typedef vnl_matrix<unsigned int> UIntMatrixType;
...
//////////////////////////////////////////////////////////////////////////
   ...
   */
  virtual unsigned int GetNumberOfCorners( void ) const = 0;
  ...
  /**
   * Return a vector of global coordinates of n-th corner in an element.
   *
   * \param n Local number of corner. Must be 0 <= n < this->GetNumberOfCorners().
   */
  virtual const VectorType GetCornerCoordinates( unsigned int n ) const = 0;
   ...
   * \param pt Point in local element coordinates.
   */
  virtual VectorType GetSolutionGlobalFromLocalCoordinates( const VectorType& pt, Solution::ConstPointer sol ) const;
