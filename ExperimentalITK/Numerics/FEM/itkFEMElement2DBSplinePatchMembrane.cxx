/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement2DBSplinePatchMembrane.cxx,v $
  Language:  C++
...
::Element2DBSplinePatchMembrane() : Superclass()
{
}
      ...
      Material::ConstPointer m_) : Superclass()
{
  ...
  {
    throw FEMExceptionWrongClass(__FILE__,__LINE__,"Element2DBSplinePatchMembrane::Element2DBSplinePatchMembrane()");
  }
}
...
FEM_CLASS_REGISTER(Element2DBSplinePatchMembrane)
