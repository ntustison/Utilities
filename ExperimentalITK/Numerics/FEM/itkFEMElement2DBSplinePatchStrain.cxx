/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement2DBSplinePatchStrain.cxx,v $
  Language:  C++
...
::Element2DBSplinePatchStrain() : Superclass()
{
}
      ...
      Material::ConstPointer m_) : Superclass()
{
  ...
  {
    throw FEMExceptionWrongClass(__FILE__,__LINE__,"Element2DBSplinePatchStrain::Element2DBSplinePatchStrain()");
  }
}
...
FEM_CLASS_REGISTER(Element2DBSplinePatchStrain)
