/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement3DLinearElasticity.h,v $
  Language:  C++
...
#ifndef __itkFEMElement3DLinearElasticity_h
#define __itkFEMElement3DLinearElasticity_h
...
/**
 * \class Element3DLinearElasticity
 ...
 *
 *   TBaseClass - Class from which Element3DLinearElasticity is derived. TBaseClass must
...
class Element3DLinearElasticity : public TBaseClass
{
FEM_ABSTRACT_CLASS(Element3DLinearElasticity,TBaseClass)
public:
...
//////////////////////////////////////////////////////////////////////////
  ...
  /**
   * 3D LinearElasticity elements have 3 DOFs per node.
   */
