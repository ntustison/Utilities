/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement3DBSplinePatchLinearElasticity.cxx,v $
  Language:  C++
...
::Element3DBSplinePatchLinearElasticity() : Superclass()
{
}
      ...
      Material::ConstPointer m_) : Superclass()
{
  ...
  {
    throw FEMExceptionWrongClass(__FILE__,__LINE__,"Element3DBSplinePatchLinearElasticity::Element3DBSplinePatchLinearElasticity()");
  }
}
...
FEM_CLASS_REGISTER(Element3DBSplinePatchLinearElasticity)
