/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement3DBSplinePatchMembrane.cxx,v $
  Language:  C++
...
::Element3DBSplinePatchMembrane() : Superclass()
{
}
      ...
      Material::ConstPointer m_) : Superclass()
{
  ...
  {
    throw FEMExceptionWrongClass(__FILE__,__LINE__,"Element3DBSplinePatchMembrane::Element3DBSplinePatchMembrane()");
  }
}
...
FEM_CLASS_REGISTER(Element3DBSplinePatchMembrane)
