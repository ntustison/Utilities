/*=========================================================================
  ...
  Module:    $RCSfile: itkFEMElement2DThinPlate.txx,v $
  Language:  C++
  Date:      $ $
  Version:   $ $
...
#ifndef __itkFEMElement2DThinPlate_txx
#define __itkFEMElement2DThinPlate_txx

#include "itkFEMElement2DThinPlate.h"
...
Element2DThinPlate<TBaseClass>
::Element2DThinPlate() : Superclass(), m_mat(0) {}
...
::Read( std::istream& f, void* info )
{
  ...
  {
    throw FEMExceptionObjectNotFound(__FILE__,__LINE__,"Element2DThinPlate::Read()",e.m_baseClassName,e.m_GN);
  }

  // Check if the material object was of correct class
  if(!m_mat)
  {
    throw FEMExceptionWrongClass(__FILE__,__LINE__,"Element2DThinPlate::Read()");
  }
...
out:
  ...
  if( !f )
  { 
    throw FEMExceptionIO(__FILE__,__LINE__,"Element2DThinPlate::Read()","Error reading FEM element!");
  }
...
::Write( std::ostream& f ) const
{
  ...
  if (!f)
  { 
    throw FEMExceptionIO(__FILE__,__LINE__,"Element2DThinPlate::Write()","Error writing FEM element!");
  }
}
...
#endif // #ifndef __itkFEMElement2DThinPlate_txx
