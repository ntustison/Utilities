/*=========================================================================
  ...
  Module:    $RCSfile: ICP.cxx,v $
  Language:  C++
  Date:      $Date: 2010/04/17 21:09:28 $
...
int ICP( itk::CommandLineParser *parser )
  {
  ...
  typedef itk::DMFFDLabeledPointSetRegistrationICPFilter<PointSetType>
...
int main( int argc, char *argv[] )
{
  ...
  parser->SetCommandDescription( "ICP Labeled Point-Set Registration" );
