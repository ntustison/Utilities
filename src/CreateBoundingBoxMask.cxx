...
int main( int argc, char *argv[] )
{
  if ( argc < 7 )
    {
    std::cout << argv[0] << " inputImage outputImage position dimensions row column inplaneRotationAngle" << std::endl;
    exit( 1 );
    }
  ...
  for( It.GoToBegin(); !It.IsAtEnd(); ++It )
    ...
    pointVector[0] = point[0];
    pointVector[1] = point[1];
    pointVector[2] = point[2];
